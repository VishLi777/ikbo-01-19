...
public class InternetOrder implements Orderable {
    ...
    public boolean add(MenuItem item) {
        try {
            ...
            System.out.println("Element cannot be added: " + e.getMessage());
            return false;
        }
        return true;
    }
    ...
    public String[] itemsNames() {
        ...
        int ind = 0;
        do {
            names[ind] = node.getValue().toString();
            ind++;
            node = node.getNext();
        } while (node != tail);
        return names;
    ...
    public MenuItem[] sortedItemsByCostDesc() {
        ...
        Arrays.sort(items, (n1, n2) -> {
            double c = n2.getCost() - n1.getCost();
            if(c==0){
                return 0;
            }else{
                return (int)c;
